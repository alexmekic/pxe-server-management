...
def mount_network_dir(backup_storage_pool, subdirectory, second_server_ip):
    ...
    if exit_code != 0:
        print("failed")
        print("Unable to mount network directory from " + second_server_ip)
            ...
            if ping_response == 0:
                ...
                while True:
                    ...
                    if backup_storage_pool == "0":
                        ...
                        if sync_type == "1":
                            mount_network_dir(backup_storage_pool, "images", second_server_ip)
                            sync_images()
                        # elif sync_type == "2":
                        #     mount_network_dir(backup_storage_pool, "tftp", second_server_ip)
...
def sync_menu(main_server_ip):
    while True:
        ...
        # print("2: Upload boot menu file to another server")
