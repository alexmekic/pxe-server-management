...
def user_input():
    while True:
        ...
        print("1: Add New restore entry")
        print("2: List current entries and restore images attached")
        print("3: List restore images in server\n")
        print("4: Change default entry")
        print("5: Change attached restore image in entry")
